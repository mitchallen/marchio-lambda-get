module.exports = function (grunt) {
    ...
    grunt.initConfig({
            ...
            dist: {
                options: {
                    browserifyOptions: {
                        ...
                        standalone: 'MitchAllen.-marchio-lambda-get'
                        // standalone: 'mitchallen.-marchio-lambda-get'
                    },
                ...
                files: {
                   ...
                   "./dist/marchio-lambda-get.js": ["./modules/index.js"]
                   // For non-standalone, use ./browser.js instead.
                   // "./dist/marchio-lambda-get.js": ["./browser.js"]
                }
            }
        },
        ...
        uglify: {
            my_target: {
                files: {
                    './dist/marchio-lambda-get.min.js': ['./dist/marchio-lambda-get.js']
                }
            }
        },
